...
let blogName = "a piece of my mind";
let authorName = "Galissia";
...
//[ "posts/2020-11-10-My-Second-Post-Example.html" ],
  ["posts/2025-01-21-New-Year-Updates.html"],
  ["posts/2024-10-17-On-a-Student-Film-Set.html"],
  ["posts/2024-10-06-Neocities-100-Questions.html"],
[ "posts/2024-10-05-Fall-Updates.html" ],
[ "posts/2024-06-10-First-Post.html" ]
];
...
let headerHTML = '<ul> <li><a class="hvr-rotate" href="' + relativePath + '/index.html">Home</a></li>' + 
'<li><a class="hvr-rotate" href="' + relativePath + '/archive.html">Archive</a></li>' +
'<li><a class="hvr-rotate" href="https://galissia.neocities.org">Main Site</a></li> </ul>';
...
let footerHTML = "<hr><p>" + blogName + " is maintained by <a href='https://neocities.org/site/galissia'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>, and hosted by <a href='https://neocities.org/'>Neocities!</a></p><center><a href='https://galissia.neocities.org/utilities/rss_blog.xml'><img src='https://galissia.neocities.org/images/rss_button.png'></a></center>";
...
function formatPostLink(i) {
  ...
  if (  postDateFormat.test ( postsArray[i][0].slice( 6,17 ) ) ) {
    return '<li><a class="hvr-rotate" href="' + relativePath + '/'+ postsArray[i][0] +'">' + postsArray[i][0].slice(6,16) + " \u00BB " + postTitle_i + '</a></li>';
  } else {
    return '<li><a class="hvr-rotate" href="' + relativePath + '/'+ postsArray[i][0] +'">' + postTitle_i + '</a></li>';
  }
}
...
if ( postsArray.length > recentPostsCutoff ) {
  recentPostListHTML += '<li class="moreposts"><a class="hvr-rotate" href=' + relativePath + '/archive.html>\u00BB more posts</a></li></ul>';
} else {
...
if ( postsArray.length < 2 ) {
  nextprevHTML = '<a class="hvr-rotate" href="' + relativePath + '/index.html">Home</a>';
} else if ( currentIndex === 0 ) {
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a class="hvr-rotate" href="' + relativePath + '/index.html">Home</a> | <a href="'+ relativePath + '/' + prevlink +'">Previous Post \u00BB</a>';
} else if ( currentIndex === postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  nextprevHTML = '<a class="hvr-rotate" href="' + relativePath + '/' + nextlink +'">\u00AB Next Post</a> | <a href="' + relativePath + '/index.html">Home</a>';
} else if ( 0 < currentIndex && currentIndex < postsArray.length - 1 ) {
  nextlink = postsArray[currentIndex - 1][0];
  prevlink = postsArray[currentIndex + 1][0];
  nextprevHTML = '<a class="hvr-rotate" href="' + relativePath + '/'+ nextlink +'">\u00AB Next Post</a> | <a href="' + relativePath + '/index.html">Home</a> | <a href="' + relativePath + '/'+ prevlink +'">Previous Post \u00BB</a>';
}
